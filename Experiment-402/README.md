...
int main(void) {
	...
	puts("Name: Abinandhan M \n");
	puts("Register.Number: 212223060004\n");/* prints Hello World!!! */
	return EXIT_SUCCESS;
}
```
## Output

![WhatsApp Image 2026-03-18 at 8 27 47 AM](https://github.com/user-attachments/assets/71f72651-d258-4a1e-82df-83fa8f64d270)
